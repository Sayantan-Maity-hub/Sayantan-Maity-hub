...
- 💡 Build real-world electronics, PCB, and simulation-based projects  
- ⚙️ Design and simulate circuits in **Arduino, Verilog, LTSpice, KiCad, Falstad**  
- 🔌 Work on **embedded systems, motor drivers, and signal conditioning**  
...
| [H-Bridge Driver and Integration](https://github.com/Sayantan-Maity-hub/Analog_system_lab_H_Bridge) | Motor driver switching simulation | LTSpice |
| [Low-Pass Filter](https://github.com/YourUsername/RC-Filter-Sim) | Simple RC low-pass filter simulation | LTSpice |
...
- Analog Electronics: `Op-Amps`, `RC Filters`, `LTSpice`, `Falstad`, `ADALM1000`  
- Power Electronics: `H-Bridge`, `MOSFET Drivers`, `PWM Control`  
- AI & Data: `Python`, `NumPy`, `Pandas`, `OpenCV`, `scikit-learn`  
- Tools: `KiCad`, `Wokwi`, `Git`, `GitHub`, `VS Code`, `MATLAB`, `Notion`  
